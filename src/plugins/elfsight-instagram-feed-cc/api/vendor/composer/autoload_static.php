...
class ComposerStaticInit7a3fe136ac4bbd5caffb95df9c75ea03
{
    public static $classMap = array (
        ...
        'ElfsightInstagramFeedApi\\IGUser' => __DIR__ . '/../..' . '/api-ig-user.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->classMap = ComposerStaticInit7a3fe136ac4bbd5caffb95df9c75ea03::$classMap;
